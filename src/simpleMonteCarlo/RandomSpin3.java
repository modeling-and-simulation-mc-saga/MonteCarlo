 ...
 * @author tadaki
 */
public class RandomSpin3 extends SpinSystem {

    /**
     * @param n the number of spins
     * @param random
     */
    public RandomSpin3(int n, Random random) {
        super(n, random);
    }
    ...
    public static void main(String args[]) throws IOException {
        ...
        long seed = 32124L;
        RandomSpin3 sys = new RandomSpin3(n, new Random(seed));

        for (int k = 0; k < numSample; k++) {
            String filename = RandomSpin3.class.getSimpleName() + "-"
